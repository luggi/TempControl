...
const clivalue_t valueTable[] = {
    ...
    {"setpoint1", VAR_FLOAT, &control.setpoint[PID1], 0, 2000},
    {"setpoint2", VAR_FLOAT, &control.setpoint[PID2], 0, 2000},
